...
// Importamos el componente principal de nuestra aplicación, 'App', desde './App.jsx'.
import App from './App';

// Importamos 'index.css'. Este archivo usualmente contiene estilos globales
...
// Usamos el método render de la raíz para renderizar nuestro componente App.
...
root.render(
  ...
  // Activa chequeos y advertencias adicionales para sus descendientes (en este caso, <App />).
  ...
  <React.StrictMode>
    {/* Renderizamos el componente App. Este es el punto de partida de la interfaz de usuario de nuestra aplicación. */}
    <App />
  </React.StrictMode>
);
